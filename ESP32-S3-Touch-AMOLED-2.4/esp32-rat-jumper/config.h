...
#define LW                    ((LCD_HEIGHT + CRT_SCALE - 1) / CRT_SCALE)   // sirka hry v bodech: 200
#define LH                    ((LCD_WIDTH + CRT_SCALE - 1) / CRT_SCALE)    // vyska hry v bodech: 150

// ===== svet (logicke body) =====
#define CEIL_H                9      // strop
#define FLOOR_Y               (LH - 25)   // horni hrana chodniku (nohy krysy): 125
#define FLOOR_H               6
#define WATER_Y               (FLOOR_Y + FLOOR_H)   // hladina vody pod chodnikem
#define LANE1_Y               (FLOOR_Y - 24)   // horni hrana policek 1. patra: 101
#define LANE2_Y               (FLOOR_Y - 48)   // 2. patro: 77
#define PLATFORM_H            6
